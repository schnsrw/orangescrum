...
.app_release_pop .rht-cont{background-size: 100% 100%;float:left;width:75%;height:100%;box-sizing:border-box;padding:0px 50px 0;    border-radius:0px 10px 10px 0px;}
...
.app_release_pop ul li:before{content:'';width:10px;height:10px;display:block;position:absolute;left:0;top:8px;}
    ...
    <div class="modal-content">
        ...
        <div class="modal-body popup-container" style="padding: 0px;">
           ...
           <div class="app_release_pop">
			  ...
			  <div class="rht-cont">
				<h2><?php echo __('OpenTask goes Mobile');?>!</h2>
				<p>
				  <?php echo __('Your favorite project management tool is now with you all the time. Use and enjoy OpenTask at your fingertips');?>.
				</p>
				<ul>
				  <li>
