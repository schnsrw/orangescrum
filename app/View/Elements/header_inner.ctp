                ...
                <div class="navbar-collapse collapse navbar-inverse-collapse pad-left-non"> 
                 <div class="right_pfl_menu<?php echo $men_col_class;?>">
                  ...
                  <?php if(PAGE_NAME !== "work_load" && PAGE_NAME !== "updates" && PAGE_NAME != "defect"){ ?>
									<?php /*<a href="javascript:void(0);" id="new_onboarding_link" class="tour_top_txt" onclick="newOnboarding();" <?php if(isset($_COOKIE['FIRST_INVITE_2'])){ ?> style="display:inline-block;"<?php }else{ ?> style="display:none;" <?php } ?>><?php echo __('Take a Tour of OpenTask');?></a>	*/ ?>
